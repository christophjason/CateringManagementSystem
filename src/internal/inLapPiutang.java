 ...
 * @author chris
 */
public class inLapPiutang extends javax.swing.JInternalFrame {

    /**
     * Creates new form inLapPiutang
     */
    public inLapPiutang() {
        initComponents();
        selectData();
    ...
    public void selectData(){
        ...
        String SQL = "SELECT * FROM lappihut WHERE piutangOrHutang = '0' "
        ...
        try {
            ...
            Logger.getLogger(inLapPiutang.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Piutang");
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        if (baris != -1) {
            ...
            String SQL = "DELETE FROM lappihut WHERE piutangOrHutang = '0', noInvoice = '"+id+"'";
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        // TODO add your handling code here:
            dlgTambahEditPIHUT tambah = new dlgTambahEditPIHUT(new javax.swing.JFrame(), closable, 0, 0, 0);
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        if(baris != -1){
            int id = Integer.parseInt(jTable4.getValueAt(baris, 0).toString());
            dlgTambahEditPIHUT edit = new dlgTambahEditPIHUT(new javax.swing.JFrame(), closable, 1, 0, id);
