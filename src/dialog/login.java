...
public class login extends javax.swing.JDialog {
    ...
    private void login() throws SQLException{
        ...
        String SQL = "SELECT * FROM account WHERE accountName = '"+username+"' AND password = '"+password+"'";
        ResultSet rs = DBConnect.executeQuery(SQL);
        if (rs.next()){
            String roleid = rs.getString("roleId");
            JOptionPane.showMessageDialog(rootPane, "Success", "Success", JOptionPane.INFORMATION_MESSAGE);
            this.setVisible(false);
            formMain main = new formMain(roleid);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("PT. MASA KEEMASAN INDONESIA");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        register dlg = new register(new javax.swing.JFrame(), rootPaneCheckingEnabled);
        dlg.setVisible(true);
