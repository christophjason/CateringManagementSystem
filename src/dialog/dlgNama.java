 ...
 * @author chris
 */
public class dlgNama extends javax.swing.JDialog {

    /**
     * Creates new form dlgNama
     */
    public dlgNama(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        selectData();
        try {
            ...
            Logger.getLogger(dlgNama.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    
    private void insertTipe() throws SQLException{
        String SQL = "SELECT * FROM nama2 GROUP BY tipe";
    ...
    public void addData(){
        ...
        String SQL = "INSERT INTO nama2 (nama,tipe) VALUES('"+nama+"','"+tipe+"')";
    ...
    public void editData(){
        ...
        if(baris != -1){
            ...
            if(nama.isEmpty()||tipe.isEmpty()){
                ...
                String SQL = "UPDATE nama2 SET nama = '"+nama+"', "
                        + "tipe = '"+tipe+"'"
                        + "WHERE namaId = '"+id+"'";
                int status = DBConnect.execute(SQL);
                if (status == 1){
    ...
    public void deleteData(){
        ...
        if (baris != -1){
            int id = Integer.parseInt(jTable1.getValueAt(baris, 0).toString());
            String SQL = "DELETE FROM nama2 WHERE namaId = '"+id+"'";
    ...
    public void selectData(){
        String[] kolom = {"ID","Nama", "Tipe"};
        DefaultTableModel dtm = new DefaultTableModel(null, kolom);
        String SQL = "SELECT * FROM nama2 ORDER BY tipe";
        ResultSet rs = DBConnect.executeQuery(SQL);
        try {
            while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgNama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgNama dialog = new dlgNama(new javax.swing.JFrame(), true);
